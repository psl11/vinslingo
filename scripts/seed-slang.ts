...
const BRITISH: Slang[] = [
  ...
  { word: 'gobby', es: 'bocazas', reg: 'casual', ex: "She's a bit gobby.", exEs: 'Es un poco bocazas.' },
  { word: 'minging', es: 'asqueroso, feo', reg: 'malsonante', ex: "The weather's minging today.", exEs: 'Hace un tiempo asqueroso hoy.' },
  { word: 'rank', es: 'asqueroso', reg: 'casual', ex: 'That smell is rank.', exEs: 'Ese olor es asqueroso.' },
  { word: 'snog', es: 'morrearse', reg: 'casual', ex: 'They were snogging in the corner.', exEs: 'Se estaban morreando en un rincón.' },
  { word: 'take the mick', es: 'vacilar, cachondearse; o pasarse', reg: 'casual', ex: 'Are you taking the mick?', exEs: '¿Me estás vacilando?' },
  ...
  { word: 'lairy', es: 'chulesco, alborotador', reg: 'casual', ex: 'He gets lairy after a few drinks.', exEs: 'Se pone chulesco tras unas copas.' },
...
const AMERICAN: Slang[] = [
  ...
  // 'hang out' vive en la categoría phave (mismo significado, con explicación y
  // mini-gramática). No es jerga, es un phrasal mainstream: aquí duplicaba la
  // ficha, así que se borró de american_slang. No re-sembrar.
  ...
  { word: 'wasted', es: 'muy borracho', reg: 'casual', ex: 'He got wasted last night.', exEs: 'Anoche se puso ciego.' },
